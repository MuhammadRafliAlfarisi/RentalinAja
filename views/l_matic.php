                    ...
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-6 col-md-5">
                                <img src="../img/matic1.3.png" class="card-img img-fluid rounded-start" alt="">
                            </div>
                            <div class="col-6 col-md-7">
                                <div class="card-body d-flex flex-column">
                                    <div class="h-100">
                                        <h2 class="card-title">Vario</h2>
                                        <h4 class="card-title mb-3">Rp<strong>75.000</strong></h4>
                                    </div>
                                    <div>
                            ...
                            <!--  -->
                            <div class="col-6 col-md-5">
                                <img src="../img/matic2.png" class="card-img img-fluid rounded-start" alt="">
                            </div>
                            <div class="col-6 col-md-7">
                                <div class="card-body d-flex flex-column">
                                    <div class="h-100">
                            ...
                            <!--  -->
                            <div class="col-6 col-md-5">
                                <img src="../img/matic3.png" class="card-img img-fluid rounded-start" alt="">
                            </div>
                            <div class="col-6 col-md-7">
                                <div class="card-body d-flex flex-column">
                                    <div class="h-100">
                                        <h2 class="card-title">Scoopy</h2>
                                        <h4 class="card-title mb-3">Rp<strong>60.000</strong></h4>
                                    </div>
                                    <div>
                                        <a href="./form.php" class="btn btn-dark">Purchase Tickets</a>
                                    </div>
                            ...
                            <!--  -->
                            <div class="col-6 col-md-5">
                                <img src="../img/matic4.png" class="card-img img-fluid rounded-start" alt="">
                            </div>
                            <div class="col-6 col-md-7">
                                <div class="card-body d-flex flex-column">
                                    <div class="h-100">
