                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <!--  -->
                            <div class="col-6 col-md-5">
                                <img src="manual2.png" class="card-img img-fluid rounded-start" alt="">
                            </div>
                            <div class="col-6 col-md-7">
                                <div class="card-body d-flex flex-column">
                                    <div class="h-100">
                            ...
                            <!--  -->
                            <div class="col-6 col-md-5">
                                <img src="manual3.png" class="card-img img-fluid rounded-start" alt="">
                            </div>
                            <div class="col-6 col-md-7">
                                <div class="card-body d-flex flex-column">
                                    <div class="h-100">
                            ...
                            <!--  -->
                            <div class="col-6 col-md-5">
                                <img src="manual4.png" class="card-img img-fluid rounded-start" alt="">
                            </div>
                            <div class="col-6 col-md-7">
                                <div class="card-body d-flex flex-column">
                                    <div class="h-100">
